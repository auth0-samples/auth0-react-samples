# Auth0 React Custom Login

This sample demonstrates how to add authentication with a custom login form to a React application using Auth0. The sample uses create-react-app.
